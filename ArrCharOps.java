...
public class ArrCharOps {
    ...
    */
    public static char[] concat(char[] arr1, char[] arr2) {
        ...
        int index = 0;
        for(int i = 0; i < arr1.length; i++){
            arrNew[index] = charAt(arr1, i);
            index++;
        }
        for(int i = 0; i < arr2.length; i++){
            arrNew[index] = charAt(arr2, i);
            index++;
        }
        return arrNew;
    }
    ...
    public static char[] subArray(char[] arr, int beginIndex, int endIndex) {
        ...
        if(arr.length == 0){    //check if arr is empty
            return null;
        }
        else{
            int index = 0;
            for(int i = beginIndex; i < endIndex; i++){
                arrNew[index] = charAt(arr, i);
                index++;
            }
            return arrNew;
        }
    ...
    public static long hashCode(char[] arr) {
        ...
        for(int i = 0; i < arr.length; i++){    //calculates hash
    ...
    public static int compareTo(String str1, String str2) {
        ...
        String sh = (str1.length() > str2.length()) ? str2 : str1;  //finds shorter string
